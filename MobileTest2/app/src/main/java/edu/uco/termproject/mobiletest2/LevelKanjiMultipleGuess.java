...
public class LevelKanjiMultipleGuess extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_kanji_multiple_guess);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LevelKanjiMultipleGuess.this, LevelKanji.class);
        ...
        box00.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ans1.equals(answerWord)) {
                    ...
                    Toast.makeText(LevelKanjiMultipleGuess.this, "Incorrect!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.guess_count:
                ...
                return true;
            case R.id.themes:
                Toast.makeText(LevelKanjiMultipleGuess.this, R.string.theme, Toast.LENGTH_LONG).show();
                return true;
            default:
